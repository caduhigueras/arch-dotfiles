Name = "nvim_shortcuts_leader"
NamePretty = "Leader Mode"
-- Icon = "applications-other"
Cache = true
HideFromProviderlist = false
Description = "List shortcuts from leader"
SearchName = true
...
function GetEntries()
	local config_map = "/home/arch/.local/share/arch-dotfiles/config/.config/walker/json/neovim_leader.json"
	local entries = {}
