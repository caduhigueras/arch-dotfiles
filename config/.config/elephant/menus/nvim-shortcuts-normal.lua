Name = "nvim_shortcuts_normal"
NamePretty = "Shortcuts Normal Mode"
-- Icon = "applications-other"
Cache = true
HideFromProviderlist = false
Description = "List shortcuts from Normal Mode"
SearchName = true
...
function GetEntries()
	local config_map = "/home/arch/.local/share/arch-dotfiles/config/.config/walker/json/neovim_normal.json"
	local entries = {}
