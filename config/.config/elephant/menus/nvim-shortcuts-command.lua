Name = "nvim_shortcuts_command"
NamePretty = "Command Mode"
-- Icon = "applications-other"
Cache = true
HideFromProviderlist = false
Description = "List shortcuts from command mode"
SearchName = true
...
function GetEntries()
	local config_map = "/home/arch/.local/share/arch-dotfiles/config/.config/walker/json/neovim_command.json"
	local entries = {}
