Name = "nvim_shortcuts_lsp"
NamePretty = "Lsp Shortcuts"
-- Icon = "applications-other"
Cache = true
HideFromProviderlist = false
Description = "List shortcuts from the LSP"
SearchName = true
...
function GetEntries()
	local config_map = "/home/arch/.local/share/arch-dotfiles/config/.config/walker/json/neovim_lsp.json"
	local entries = {}
